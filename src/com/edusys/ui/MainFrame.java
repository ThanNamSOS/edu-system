...
public class MainFrame extends javax.swing.JFrame {
    ...
    void openDoiMatKhau() {
        if (Auth.isLogin()) {
            JInternalFrame internalFrame = new DoiMatKhauFrame();
    ...
    void openKhoaHoc() {
        if (Auth.isLogin()) {
            KhoaHocFrame frame = new KhoaHocFrame();
            DesktopPane.add(frame);
            frame.setVisible(true);
        }
    }
    ...
    void openChuyenDe() {
        if (Auth.isLogin()) {
            ChuyenDeFrame frame = new ChuyenDeFrame();
            DesktopPane.add(frame);
            frame.setVisible(true);
        }
    }
    ...
    void openNguoiHoc() {
        if (Auth.isLogin()) {
            NguoiHocFrame frame = new NguoiHocFrame();
            DesktopPane.add(frame);
            frame.setVisible(true);
        }
    }
    ...
    void openHocVien() {
        if (Auth.isLogin()) {
            HocVienFrame frame = new HocVienFrame();
            DesktopPane.add(frame);
            frame.setVisible(true);
        }
    }
    ...
    void openGioiThieu() {
        if (Auth.isLogin()) {
            new GioiThieuFrame(this, true).setVisible(true);
        }
    }
